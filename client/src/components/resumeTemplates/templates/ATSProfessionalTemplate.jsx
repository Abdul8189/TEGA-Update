...
const ATSProfessionalTemplate = ({ formData }) => {
  const data = formData || {
    personalInfo: {
      ...
      summary: 'Analytical professional with 6+ years of experience in data analysis, business intelligence, and statistical modeling. Expert in SQL, Python, and data visualization tools with a proven track record of driving data-driven business decisions.'
    },
    experience: [
      {
        ...
        endDate: '',
        current: true,
        description: 'Analyzed large datasets to identify business trends and opportunities. Created automated reporting systems that reduced manual reporting time by 70%. Collaborated with cross-functional teams to implement data-driven solutions.'
      }
    ],
    education: [
      {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white text-black font-sans">
      {/* Header */}
      <header className="text-center mb-8 border-b border-gray-400 pb-6">
      ...
      {data.experience && data.experience.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4 border-b-2 border-gray-300 pb-1">PROFESSIONAL EXPERIENCE</h2>
      ...
      {data.education && data.education.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4 border-b-2 border-gray-300 pb-1">EDUCATION</h2>
      ...
      {data.skills && data.skills.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4 border-b-2 border-gray-300 pb-1">TECHNICAL SKILLS</h2>
          <div className="text-gray-700">
      ...
      {data.projects && data.projects.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4 border-b-2 border-gray-300 pb-1">PROJECTS</h2>
      ...
      {data.certifications && data.certifications.length > 0 && (
        <section className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4 border-b-2 border-gray-300 pb-1">CERTIFICATIONS</h2>
