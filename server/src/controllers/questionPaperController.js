...
export const uploadQuestionPaper = async (req, res) => {
  try {
    ...
    const questionPaperData = {
      ...
      isTegaExamPaper: isTegaExamPaper || false,
    ...
    // Only add courseId if it's not a TEGA exam paper and courseId is provided
    if (!isTegaExamPaper && courseId && courseId.trim() !== '') {
      questionPaperData.courseId = courseId;
    }
    // For TEGA exam papers, don't set courseId at all - let schema default to null
